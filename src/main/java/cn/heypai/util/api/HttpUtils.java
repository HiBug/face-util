...
public class HttpUtils {
	 ...
	 * 不带文件参数的请求
	 */
	public static void post(String url, Map<String, String> params, TransCallBack callback) {
	 ...
	 * 带文件参数的请求
	 */
	public static void post(String url, final Map<String, String> params, byte[] file, TransCallBack callback) {
	 ...
	 * 带文件参数的请求
	 */
	public static void post(String url, final Map<String, String> params, Map<String, byte[]> file, TransCallBack callback) {
	 ...
	 * 带文件参数的请求
	 */
	public static void post(String url, final Map<String, String> params, Map<String, byte[]> file1, Map<String, byte[]> file2, TransCallBack callback) {
		try {
			// 构建请求体
	 ...
	 * 发送请求
	 */
	private static void doPost(Request request, final TransCallBack callback) {
